function getCandidates(skip = 0, filter = '') {
  return `SELECT candidate.id, candidate.rus_first_name, candidate.rus_second_name,
...
function getCandidateOtherSkills(id) {
